...
class PersonalizationMultiChipSelector extends StatefulWidget {
  ...
  const PersonalizationMultiChipSelector({
    super.key,
  ...
  @override
  State<PersonalizationMultiChipSelector> createState() =>
      _MultiChipSelectorState();
}

class _MultiChipSelectorState extends State<PersonalizationMultiChipSelector> {
