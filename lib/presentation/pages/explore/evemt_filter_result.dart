...
class EventFilterResult extends StatefulWidget {
  const EventFilterResult({super.key});

  @override
  State<EventFilterResult> createState() => _EventFilterResultState();
}

class _EventFilterResultState extends State<EventFilterResult> {
        ...
        children: [
          ...
          Row(
            ...
            children: [
              const Text('8 events'),
              TextButton(
                  onPressed: () {}, child: const Text('Clear filters (8)'))
            ],
          ),
